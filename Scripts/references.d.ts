...
/// <reference path="definitions/definitelyTyped/crossroads/crossroads.d.ts" />
/// <reference path="definitions/definitelyTyped/hasher/hasher.d.ts" />
...
/// <reference path="definitions/custom/toastr/toastr.d.ts" />
/// <reference path="definitions/custom/bootstrap.datepicker/bootstrap.datepicker.d.ts" />
